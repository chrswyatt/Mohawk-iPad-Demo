...
b);i(e,a,b);j(d,a,b)}}}},{match:function(a){return a.is("select")&&!q(a)?!0:!1},apply:function(a,b){var c,d,e,g;g=a.width();c=m(a,b,{css:{opacity:0,width:100+"%"},divClass:b.selectClass,spanHtml:(a.find(":selected:first")||a.find("option:first")).html(),spanWrap:"before"});d=c.div;e=c.span;b.selectAutoWidth?(d.width(f("<div />").width()-f("<span />").width()+g+25),c=parseInt(d.css("paddingLeft"),10),e.width(g-c-15),a.width(g+c),a.css("min-width",g+c+"px"),d.width(g+c)):(c=a.width(),d.width(c),
